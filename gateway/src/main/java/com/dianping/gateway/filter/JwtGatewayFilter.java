...
public class JwtGatewayFilter implements GlobalFilter, Ordered {
    ...
    @Value("${gateway.white-list:/api/auth/login,/api/auth/register,/api/auth/admin/login,/api/merchants/login,/actuator/health,/api/public,/api/shops,/api/posts,/api/recommendations}")
